...
public class SandboxArreglos
{
    ...
    public void agregarCadena( String cadena )
    {
    	...
    	nuevo_arreglo[arregloCadenas.length]= cadena;
    ...
    public void eliminarEntero( int valor )
    {
    	...
    	int nuevo_tamaño= arregloEnteros.length - contador;
    	int [] nuevo_arreglo= new int[nuevo_tamaño];
    	...
    	for(int i = 0; i < arregloEnteros.length; i++)
    	{
    		if (arregloEnteros[i] != valor)
    		{
    			nuevo_arreglo[posicion]= arregloEnteros[i];
    			posicion++;
    		}
    	}
    ...
    public void eliminarCadena( String cadena )
    {
    	...
    	int nuevo_tamaño = arregloCadenas.length - contador;
    	String[] nuevo_arreglo = new String[nuevo_tamaño];
    	
    	int posicion = 0;
    	for (int i = 0; i < arregloCadenas.length; i++)
    		if (arregloCadenas[i] != cadena)
    		{
    			nuevo_arreglo[posicion]= arregloCadenas[i];
    			posicion++;
    		}
    	arregloCadenas= nuevo_arreglo;
    }
    ...
    public void eliminarEnteroPorPosicion( int posicion )
    {
        ...
        for (int i = 0; i < arregloEnteros.length; i++)
        {
            if (i != posicion)
            {
                nuevo_arreglo[lugar] = arregloEnteros[i];
                lugar++;
            }
        }
    ...
    public HashMap<Integer, Integer> calcularHistograma( )
    {
        ...
        for (int i = 0; i < arregloEnteros.length; i++)
        {
            ...
            {
                int cantidad = histograma.get(valor);
                histograma.put(valor, cantidad + 1);
            }
            else
            {
    ...
    public int contarEnterosRepetidos( )
    {
        ...
        for (Integer cantidad : histograma.values())
        {
            if (cantidad > 1)
            {
                contador++;
    ...
    public boolean mismosEnteros( int[] otroArreglo )
    {
        ...
        int[] copiaLocal = getCopiaEnteros();
        ...
        for (int i = 0; i < copiaLocal.length - 1; i++)
        {
            for (int j = 0; j < copiaLocal.length - 1 - i; j++)
            {
                if (copiaLocal[j] > copiaLocal[j + 1])
                {
                    int temp = copiaLocal[j];
                    copiaLocal[j] = copiaLocal[j + 1];
                    copiaLocal[j + 1] = temp;
                }
            }
        }
        ...
        for (int i = 0; i < copiaLocal.length; i++)
        {
            if (copiaLocal[i] != copiaOtro[i])
            {
                return false;
            }
        }
